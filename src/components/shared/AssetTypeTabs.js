        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`
              ...
              ${
                activeType === tab.id
                  ? 'border-accent dark:border-accent-dark text-accent dark:text-accent-dark font-semibold bg-accent/5 dark:bg-accent-dark/5'
                  : 'border-transparent text-primary-text/70 dark:text-primary-text-dark/70 hover:text-primary-text dark:hover:text-primary-text-dark hover:border-accent/30 dark:hover:border-accent-dark/30 hover:bg-accent/5 dark:hover:bg-accent-dark/5'
              }
            `}
          >
            {tab.icon}
