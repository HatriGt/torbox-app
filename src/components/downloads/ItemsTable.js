  ...
  return (
    <>
      ...
      {isClient && showMobileNotice && (
        <div className="md:hidden p-3 my-2 bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 rounded-xl text-sm flex justify-between items-center shadow-sm">
          <p>
